(function (window) {             
   ...
   HtmlDocument.prototype.toFrame = function() {
    ...
    function Block(element) {
        ...
        this.code = this.element.text().split(/\n/g);
    ...
    function TestRunnerHandler() {
        var element = this.element;
        var code = _(["assets/js/boot.js\n"]).concat(this.code).value();        
        ...
        return function() {                    
            element.hide();            
            loader(code, frame, function(frameWindow) { 
